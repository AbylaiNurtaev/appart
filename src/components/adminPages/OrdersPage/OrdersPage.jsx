...
import s from './OrdersPage.module.sass';
                ...
                {questions.map((elem) => (
                    <div className={s.question} key={elem._id} style={elem.hidden === "true" ? { filter: 'grayscale(100%)' } : null}>
                        ...
                        <div className={s.info}>
                            ...
                            <div className={s.row}>
                                <div className={s.phone}>Даты: {elem.entry} - {elem.exit}</div>
                                <div className={s.phone}>Телефон: {elem.phone}</div>
                                <div className={s.questionText}>Гостей: {elem.quests[0]}</div>
                            </div>
                        </div>
